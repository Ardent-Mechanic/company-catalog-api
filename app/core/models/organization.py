...
class OrganizationActivity(Base):
    ...
    def __repr__(self) -> str:
        return (
            f"OrganizationActivity(organization_id={self.organization_id}, "
...
class Organization(Base):
    ...
    distance: Mapped[Distance] = query_expression(
        default_expr=null()
    )  # Временное поле для хранения расстояния при поиске nearby
